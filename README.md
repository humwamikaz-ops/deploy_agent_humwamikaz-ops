...
# How it works
It promts user to enter a name/number of their choice
...
Lastly, the code checks if there is ptython 3 installed. If it isn't you'll see a warning message. if it's there you're told that it is installed.
